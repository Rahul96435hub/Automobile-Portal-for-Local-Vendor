...
<body style="background-color: #f0f1f2;">
	...
	<div class="container">
<h3 class="text-danger text-center p-3">----Hero Motors Part----</h3>
		<div class="row p-5">
...
<!-- Start of Hero Part -->
			...
			<div class="col-md-3 p-2">
				<a href="https://ecatalogue.heromotocorp.biz:8080/Hero">
					<div class="card">
						<div class="card-body text-center">
							<i class="fa-solid fa-box-open fa-3x text-warning	"></i><br>
							<h4>e-part Catalogue</h4>
							------------
						</div>
					</div>
				</a>
