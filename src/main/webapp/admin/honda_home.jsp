...
<body style="background-color: #f0f1f2;">
	...
	<div class="container">
<h3 class="text-danger text-center p-3">----Honda Motors Part----</h3>
		<div class="row p-5">
		
<!-- Start of TVS Part -->
			<div class="col-md-3 p-2">
				<a href="honda_addpart.jsp">
					<div class="card">
